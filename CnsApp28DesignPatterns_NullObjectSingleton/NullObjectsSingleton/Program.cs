...
/* 20180415 */
/* P13_DesignPatterns_04 */
/* Null-Objects Pattern + Singleton Pattern (mod di corso-enaip-2019/code/14_DesignPatterns/P13_DesignPatterns_03/PayCheckCalculators). */

namespace PayDay_d
{
    /* Rispetto al progetto precedente, vogliamo risolvere il problema di duplicazione sui vari Calculator: tutti hanno gli stessi identici check sui parametri d'ingresso.
     * Per evitare la duplicazione possiamo usare il pattern TEMPLATE (vedi classe 'BasePayCheckCalculator').
     * 
     * NOTA: Usare il pattern TEMPLATE va bene quando ho una singola funzionalità che varia in modo polimorfico (qui i Calculator, il cui unico scopo è calcolare l'ammontare della paga dato un Employee e un intervallo di riferimento).
