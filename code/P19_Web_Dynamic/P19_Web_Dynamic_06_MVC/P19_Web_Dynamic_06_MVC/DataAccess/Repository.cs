...
namespace P19_Web_Dynamic_06_MVC.DataAccess
{
    public class Repository
    {
        ...
        public List<VillainRowViewModel> GetAllVillains()
        {
          ...
          public List<VillainOnlyIdNameViewModel> GetAllVillains_OnlyIdName()
        {
            return _villains
                .Select(x => new VillainOnlyIdNameViewModel
                {
                    ID = x.Id,
                    VillainName = x.VillainName
                })
        ...
        public List<Villain> GetAllCompleteVillains0()
        {
            return _villains
                .Select(x => new Villain
                {
                    Id = x.Id,
        ...
        public List<VillainForSuperHeroEditViewModel> GetVillainsForSuperHeroEditViewModel()
        {
            List<VillainForSuperHeroEditViewModel> outList = new List<VillainForSuperHeroEditViewModel>();

            foreach (Villain v in _villains)
            {
                outList.Add(new VillainForSuperHeroEditViewModel(v.Id, v.VillainName));
            }
