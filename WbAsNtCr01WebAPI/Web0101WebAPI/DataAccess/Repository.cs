...
//using Web0101WebAPI.Infrastructure.Exceptions;
using Web0101WebAPI.Infrastructure;
using Web0101WebAPI.Models;
using Web0101WebAPI.ViewModels;

namespace Web0101WebAPI.DataAccess
{
    public class Repository
    {
        ...
        //List<Villain> spr.Enemies= new List<Villain> { };
        //List<Villain> bat.Enemies = new List<Villain>() { jkr};
        //List<Villain> ww.Enemies = new List<Villain> { };
        //List<Villain> plc.Enemies = new List<Villain> { jkr, mgn, frd, jsn };
        //List<Villain> xvr.Enemies = new List<Villain> { mgn };
        #endregion
        ...
        private List<SuperHero> _superHeroes = new List<SuperHero>
            {
            new SuperHero
                { ID=1,NameSecret="Kal El", NameHero="SuperMan", Strength=100,  AssetsValue=100, CanFly=true, Powers="Heat-ray, Bullet-proof, Ice-breath"},
            new SuperHero
                { ID=2, NameSecret="Bruce Wane", NameHero="BatMan", Strength=9,  AssetsValue=100_000_000_000, CanFly=false, Powers="Ninja, Tech"},
            new SuperHero
                { ID=3,NameSecret="Diana Prince", NameHero="WonderWoman", Strength=70,  AssetsValue=100_000, CanFly=true, Powers="Truth-lazo, Bullet-proof"},
            new SuperHero
                { ID=4,NameSecret="Police", NameHero="Police", Strength=5,  AssetsValue=100_000, CanFly=true, Powers="Law, Bribes"},
            new SuperHero
                { ID=5,NameSecret="Charles Xavier", NameHero="Prof.X", Strength=1,  AssetsValue=80_000_000, CanFly=true, Powers="PSI, Patrick Stewart"},
            };
        ...
        #region villains
        private List<Villain> _villains = new List<Villain>
        {
            new Villain
            { ID=1, NameSecret="NA", NameVillain="The Joker", CanFly=false, Characteristics="Mad, Poison-specialist", Debut=new DateTime(1940,4, 25), KidnappedPeople=1337, KilledPeople=888, Strength=6},
            new Villain
            { ID=2,NameSecret="Max Eisenhardt AKA Erik Magnus Lehnsherr", NameVillain="Magneto", CanFly=true, Characteristics="Magnetist, Ego", Debut=new DateTime(1963,9,1), KidnappedPeople=1000, KilledPeople=2221, Strength=3},
            new Villain
            { ID=3, NameSecret="Fred Krueger", NameVillain="Freddy Krueger", CanFly=false, Characteristics="Immortal, Mask", Debut=new DateTime(1984,1,1), KidnappedPeople=5, KilledPeople=30, Strength=10},
            new Villain
            { ID=4, NameSecret="Jason Voorhees", NameVillain="Jason", CanFly=false, Characteristics="Immortal, Scalpels", Debut=new DateTime(1980,1,1), KidnappedPeople=1, KilledPeople=45,Strength=1}
        };
